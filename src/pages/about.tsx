      ...
      <Container>
        ...
        <article>
          <p>
            ...
            Canada in 2018. I am currently working with both JavaScript (TypeScript, React.js, Node,
            Gatsby, and Ionic) and Python (Flask, Django etc).
          </p>
          <p>
            ...
            &quot;Multimedia Web Design&quot; at the University of Gloucestershire. My professional
            start was in a few agencies developing bespoke WordPress themes amongst other things
            like AI powered Chat Bots, and interactive direct-marketing campaigns. Now I&apos;m
            building the future of loyalty at <El href="https://www.points.com">Points.com</El>.
          </p>
          <blockquote>
            <Reading book={book} />
          </blockquote>
          ...
          <p>
            This site is built with GatsbyJS using MDX for posts and styled-components to handle the
            design. All deployed via Netlify from its home on
            <El href={siteRepoLink}>jamesrwilliams/personal-site</El>, and is a full progressive web
            app! Using Algolia for my search service. This is the natural replacement for my
